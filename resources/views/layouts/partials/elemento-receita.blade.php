<div class="card border-0 shadow-sm mb-4" style="border-radius: 12px; overflow: hidden;">
    <div class="card-body p-0">
        <div class="d-flex card-accent-line align-items-center p-4">
            ...
            <div class="ms-4">
                <span class="glossary-label text-primary fw-bold text-uppercase mb-1">Elemento de Receita</span>
                <h4 class="mb-0 text-dark fw-bold" style="font-family: 'Inter', sans-serif; letter-spacing: -0.5px;">
                    <span class="text-primary opacity-75">{{ $elemento->estrutural }}</span>
