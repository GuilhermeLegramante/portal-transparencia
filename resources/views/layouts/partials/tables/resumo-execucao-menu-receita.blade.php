@php
    /**
     * Partial: resumo-execucao
     * Usado para listar o histórico de DESPESA por exercício.
     * Espera as variáveis: $resumoAnual e $detailsRoute
     */
    $columns = [
...
<x-tabela-transparencia :titulo="$titulo ?? 'Resumo da movimentação por exercício'" cor="primary" :colunas="$columns">
    @forelse($resumoAnual as $resumo)
        <tr>
            ...
            <td class="text-center">
                {{-- Note que passamos o exercício como parâmetro para a rota --}}
        ...
        <tr>
            <td colspan="6" class="text-center py-4">
                <div class="text-muted">
                    <i class="fa fa-info-circle me-1"></i> Nenhum registro encontrado.
                </div>
            </td>
        </tr>
    @endforelse
