...
@section('content')
    <div class="container">
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb bg-light p-2 rounded">
                ...
                <li class="breadcrumb-item text-muted">
                    <a href="{{ route('planejamento.loa.receita', ['filtro' => 'recurso']) }}">
                        Por Recurso</a>
                </li>
        ...
        <x-tabela-transparencia titulo="Detalhamento por Recurso - Previsão para o Exercício {{ $exercicio }}"
        ...
        <a href="{{ route('planejamento.loa.receita', ['filtro' => 'recurso']) }}" class="btn btn-secondary">
