            ...
            <div class="dark-table-wrapper">
                <x-tabela-transparencia titulo="Quadro Comparativo Consolidado das Despesas" :colunas="[
                    ...
                    <tr class="align-middle">
                        ...
                        <td
                            class="text-end {{ $resumoAnual->valor_orcado_exercicio - ($resSummary = $resumoAnual->valor_orcado_anterior >= 0 ? 'text-success' : 'text-danger') }}">
                            R$
                    ...
                    <tr class="align-middle">
                        ...
                        <td class="text-end dark-text-white">R$
